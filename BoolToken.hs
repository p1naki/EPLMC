...
alex_table = listArray (0 :: Int, 258)
  [ 0
  , 2
  , 1
  , 2
...
alex_check = listArray (0 :: Int, 258)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_2 =  \s -> BFTokenAnd 
alex_action_3 =  \s -> BFTokenOr 
alex_action_4 =  \s -> BFTokenNeg 
alex_action_5 =  \s -> BFTokenLParen 
alex_action_6 =  \s -> BFTokenRParen 
alex_action_7 =  \s -> BFTokenSym ((P . read) s) 
