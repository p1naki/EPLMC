...
alex_table = listArray (0 :: Int, 352)
  [ 0
  , 3
  , 2
  , 3
...
alex_check = listArray (0 :: Int, 352)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_2 =  \s -> PtTokenEps 
alex_action_3 =  \s -> PtTokenDel 
alex_action_4 =  \s -> PtTokenAlt 
alex_action_5 =  \s -> PtTokenCat 
alex_action_6 =  \s -> PtTokenStar 
alex_action_7 =  \s -> PtTokenLParen 
alex_action_8 =  \s -> PtTokenRParen 
alex_action_9 =  \s -> PtTokenSym (head s) 
alex_action_10 =  \s -> PtTokenTest ((parseBForm . tail) s) 
